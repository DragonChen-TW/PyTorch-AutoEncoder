...
def get_dataset(data_name):
    if data_name == 'cifar10':
        ...
        train_data, test_data = get_mnistm()
    elif data_name == 'mnistm_1channel':
        train_data, test_data = get_mnistm(to_gray=True)
    elif data_name == 'mnist':
        train_data, test_data = get_mnist()
    elif data_name == 'mnist_3channel':
        train_data, test_data = get_mnist(to_rgb=True)
    elif data_name == 'svhn':
        train_data, test_data = get_svhn()
    elif data_name == 'svhn_random':
        train_data, test_data = get_svhn_random()
    elif data_name == 'syn_number':
        train_data, test_data = get_syn_number()
